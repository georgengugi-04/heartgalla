...
export const artworks: Artwork[] = [
  ...
  { id: "a19", title: "The Carriage and the Wolf Pack", slug: "carriage-and-the-wolf-pack", artistId: "lenny", image: "/art/lenny/carriage-and-the-wolf-pack.jpg", year: null, medium: null, dimensions: null, description: "A lantern-lit carriage and its two horses pause on a forest track at night, painted in cool purples and greys. A line of wolves stands silhouetted along the ridge behind, watching from higher ground. Bare, crossing branches fill the upper half of the canvas, with two birds perched among them.", price: null, currency: "KES", availability: "unlisted", collection: null, featured: false, tags: ["landscape", "wildlife"] },
  { id: "a20", title: "Two Animals in Snowfall", slug: "two-animals-in-snowfall", artistId: "lenny", image: "/art/lenny/two-animals-in-snowfall.jpg", year: null, medium: null, dimensions: null, description: "Two animals lean into each other against a backdrop of bare winter trees, snow falling around them in scattered white flecks. Their fur is built from long, layered strokes of orange and black, close enough in tone and pose that the two bodies read as one shape at first glance.", price: null, currency: "KES", availability: "unlisted", collection: null, featured: false, tags: ["wildlife"] },
  { id: "a21", title: "Antelope by the Water", slug: "antelope-by-the-water", artistId: "lenny", image: "/art/lenny/antelope-by-the-water.jpg", year: null, medium: null, dimensions: null, description: "An antelope stands in silhouette at the edge of a still pool, its reflection completing the shape below. A large pale moon rises behind a leaning tree, one bird crossing in front of it. The sky moves through grey, orange and gold in horizontal bands.", price: null, currency: "KES", availability: "unlisted", collection: "Land & Light", featured: false, tags: ["wildlife", "landscape"] },
  { id: "a22", title: "Portrait in Red, Gold and Green", slug: "portrait-in-red-gold-and-green", artistId: "lenny", image: "/art/lenny/portrait-in-red-gold-and-green.jpg", year: null, medium: null, dimensions: null, description: "A woman with long dreadlocks, beaded and wrapped, looks directly out of the canvas against a sunset backdrop of palm fronds in red, gold and green. A small dark silhouette — an animal figure — sits just behind her shoulder, easy to miss against the background at first look.", price: null, currency: "KES", availability: "unlisted", collection: null, featured: false, tags: ["portrait"] },
  ...
  { id: "b7", title: "Portrait Study, Inverted", slug: "portrait-study-inverted", artistId: "john", image: "/art/john/portrait-study-inverted.jpg", year: null, medium: "Ballpoint pen", dimensions: null, description: "A face rendered in blue ballpoint, drawn and framed upside down — the features read clearly once turned, built from loose, repeated pen strokes rather than a single continuous line.", price: null, currency: "KES", availability: "unlisted", collection: null, featured: false, tags: ["portrait", "sketch"] },
  { id: "b8", title: "Portrait Study (Pencil)", slug: "portrait-study-pencil", artistId: "john", image: "/art/john/portrait-study-pencil.jpg", year: null, medium: "Pencil", dimensions: null, description: "A three-quarter pencil portrait of a smiling man, built up in soft graphite shading with the darkest values reserved for his shirt and the shadowed side of his face.", price: null, currency: "KES", availability: "unlisted", collection: null, featured: false, tags: ["portrait", "sketch"] },
  { id: "b9", title: "Portrait in a Patterned Cap", slug: "portrait-in-a-patterned-cap", artistId: "john", image: "/art/john/portrait-in-a-patterned-cap.jpg", year: null, medium: "Pencil", dimensions: null, description: "A pencil portrait of a man in a textured, patterned cap and collared shirt, drawn with careful attention to the cap's raised, embossed-looking texture against the smoother shading of the face.", price: null, currency: "KES", availability: "unlisted", collection: null, featured: false, tags: ["portrait", "sketch"] },
  { id: "b10", title: "Lion Study (Ink)", slug: "lion-study-ink", artistId: "john", image: "/art/john/lion-study-ink.jpg", year: null, medium: "Ballpoint pen", dimensions: null, description: "A lion's head and mane in loose, scribbled ballpoint linework, with a smaller, less resolved figure sketched beneath it on the same page.", price: null, currency: "KES", availability: "unlisted", collection: null, featured: false, tags: ["sketch", "wildlife"] },
  { id: "b11", title: "Portrait Sketch", slug: "portrait-sketch", artistId: "john", image: "/art/john/portrait-sketch.jpg", year: null, medium: "Ballpoint pen", dimensions: null, description: "A quick, loosely worked ballpoint portrait of a smiling face, left at a looser, more exploratory stage than the collection's pencil portraits.", price: null, currency: "KES", availability: "unlisted", collection: null, featured: false, tags: ["portrait", "sketch"] },
