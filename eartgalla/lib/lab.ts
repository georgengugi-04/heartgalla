/**
 * Curated lists for the Art Lab experiments that work with artworks. Everything comes from
...
/** Experiment 08 — Curate Your Wall: the pieces in the tray. */
const WALL_SLUGS = [
  "happiness",
...
export const getWallWorks = (): CollectionItem[] => getWorks(WALL_SLUGS);
