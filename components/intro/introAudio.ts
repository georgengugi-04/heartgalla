 ...
 * host or download. Roughly 20 seconds: a warm pad moving Dm9 → B♭maj7 → Gm9 → Fmaj9 → Cadd9
...
export const INTRO_SECONDS = 19.5;
...
const CHORDS: Chord[] = [
  ...
  { at: 14.0, until: 19.5, bass: 36, pad: [55, 60, 62, 64, 67] }, // Cadd9  — the resolution / EARTGALLA
];
...
const PLUCKS: [number, number, number][] = [
  ...
  [14.3, 79, 0.1], [14.9, 84, 0.09], [15.6, 86, 0.08], [16.4, 79, 0.07], [17.1, 76, 0.06], [17.9, 72, 0.05],
];
